<?php
    if(isset($_POST['yourmail'])) {
        ...
        $email_subject = "Contact from SUBWAY template";
         
        
        $name = $_POST['yourname']; // required
        $email_from = $_POST['yourmail']; // required
        ...
        $email_message .= "Subject: ".clean_string('Subway - contact form')."\n";
